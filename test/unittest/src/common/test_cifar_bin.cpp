...
TEST(cifar_bin, get_image_opencv) {
  std::string file_path = "../resource/cifar-100-binary/test.bin";
  auto cifar = CifarBin(file_path);
...
TEST(cifar_bin, get_image_label) {
  std::string file_path = "../resource/cifar-100-binary/test.bin";
  auto cifar = CifarBin(file_path);
